...
class EventDaoTest {
    ...
    @Test
    fun `getEventsListOnCondition empty case`() =
        runBlocking {
            val actual =
                dao.getEventsListOnCondition(
    ...
    @Test
    fun `getEventsListOnCondition emptyList case`() =
        runBlocking {
            val actual =
                dao.getEventsListOnCondition(
                    mainCondition = DSL.noCondition(),
    ...
    @Test
    fun `getEventsListOnCondition main case`() =
        runBlocking {
    ...
    @Test
    fun `getEventsListOnCondition main with main condition and batch case`() =
        runBlocking {
            val accountGuid = UUID.randomUUID()
            val accountGuid2 = UUID.randomUUID()
            val aggregatorGuid = UUID.randomUUID()

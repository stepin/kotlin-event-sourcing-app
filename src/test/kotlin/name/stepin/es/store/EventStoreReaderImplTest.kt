...
class EventStoreReaderImplTest {
    ...
    @Test
    fun `findEventsSinceId defaults case`() =
        runBlocking {
            val expectedEvent = userRegistered(1)
            val eventRecord1 =
                createEventRecord(1, type = "UserRegistered").apply {
                    body =
                        JSONB.valueOf(
                            """
    ...
    @Test
    fun `findEventsSinceId main case`() =
        runBlocking {
            val expectedEvent = userRegistered(1)
            val eventRecord1 =
                createEventRecord(1, type = "UserRegistered").apply {
            ...
            val actual =
                service.findEventsSinceId<DomainEvent>(
                    eventIdFrom = 10,
                    aggregator = findAggregator,
                    aggregatorGuid = findUserGuid,
                    accountGuid = findAccountGuid,
    ...
    @Test
    fun `findEventsSinceGuid not found case`() =
        runBlocking {
    ...
    @Test
    fun `findEventsSinceGuid defaults case`() =
        runBlocking {
            val expectedEvent = userRegistered(1)
            val eventRecord1 =
                createEventRecord(1, type = "UserRegistered").apply {
    ...
    @Test
    fun `findEventsSinceGuid main case`() =
        runBlocking {
            val expectedEvent = userRegistered(1)
            val eventRecord1 =
                createEventRecord(1, type = "UserRegistered").apply {
            ...
            val actual =
                service.findEventsSinceGuid<DomainEvent>(
    ...
    @Test
    fun `findEventsSinceDate defaults case`() =
        runBlocking {
            val expectedEvent = userRegistered(1)
            val eventRecord1 =
                createEventRecord(1, type = "UserRegistered").apply {
    ...
    @Test
    fun `findEventsSinceDate main case`() =
        runBlocking {
            val expectedEvent = userRegistered(1)
            val eventRecord1 =
                createEventRecord(1, type = "UserRegistered").apply {
            ...
            val actual =
                service.findEventsSinceDate<DomainEvent>(
                    date = findFromDate,
                    aggregator = findAggregator,
                    aggregatorGuid = findUserGuid,
                    accountGuid = findAccountGuid,
    ...
    fun `findEvents main case`() =
        runBlocking {
            ...
            val actual =
                service.findEvents<DomainEvent>(
                    aggregator = findAggregator,
                    aggregatorGuid = findUserGuid,
                    accountGuid = findAccountGuid,
                    eventTypes = findEventTypes,
